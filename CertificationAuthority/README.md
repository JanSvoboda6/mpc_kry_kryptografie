...
Pokud se uživatel bude chtít vydat na stránky [https://www.securestorage.website/](https://www.securestorage.website/) narazí na chybu ustanovení SSL bezpečného spojení. K úspěšnému ustanovení spojení je zapotřebí na klientský stroj nainstalovat certifikát certifikační autority. Ten slouží k ověření totožnosti cílového WWW serveru prohlížeči který dotaz inicioval. Certifikát lze najít na této adrese: [https://github.com/JanSvoboda6/mpc_kry_kryptografie/blob/main/CertificationAuthority/ProjectCertificates/Root-CustomCA.crt?raw=1](https://github.com/JanSvoboda6/mpc_kry_kryptografie/blob/main/CertificationAuthority/ProjectCertificates/Root-CustomCA.crt?raw=1) (pro uložení: pravé tlačítko myši -> Save link as...). 
